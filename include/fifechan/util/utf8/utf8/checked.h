...
namespace utf8
{
    ...
    public:
        ...
        virtual char const * what() const UTF_CPP_NOEXCEPT UTF_CPP_OVERRIDE
        {
    ...
    {
        static utfchar32_t const replacement_marker = static_cast<utfchar32_t>(utf8::internal::mask16(0xfffd));
        return utf8::replace_invalid(start, end, out, replacement_marker);
    }

    inline std::string replace_invalid(std::string const & s, utfchar32_t replacement)
    {
        std::string result;
    ...
    inline std::string replace_invalid(std::string const & s)
    {
        std::string result;
    ...
    octet_iterator utf16to8(u16bit_iterator start, u16bit_iterator end, octet_iterator result)
    {
        while (start != end) {
            ...
            if (utf8::internal::is_lead_surrogate(cp)) {
                if (start != end) {
                    utfchar32_t const trail_surrogate = static_cast<utfchar32_t>(utf8::internal::mask16(*start++));
    ...
    {
        while (start < end) {
            utfchar32_t const cp = utf8::next(start, end);
    ...
    public:
        ...
        iterator() { }
        explicit iterator(
            octet_iterator const & octet_it, octet_iterator const & rangestart, octet_iterator const & rangeend) :
