/**
 * AllegroGL widgets example for Guichan.
 */

// Include all necessary headers.
#include <iostream>
#if defined (_WIN32)
#include <winalleggl.h>
...
gcn::OpenGLAllegroImageLoader* imageLoader;  // For loading images
...
void init()
{
    ...
    graphics->setTargetPlane(SCREEN_W, SCREEN_H);
    ...
    gui->setTop(top);
    // Load the image font.
    guiFont = new gcn::ImageFont("fixedfont.bmp",
